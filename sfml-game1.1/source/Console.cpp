...
void Console::Draw(const char* title)
{
	...
	//Top Console
	ImGui::TextWrapped("Game Version: 0.0000");
	ImGui::TextWrapped("Enter 'HELP' for help, press TAB to use text completion.");

	// TODO: display items starting from the bottom
	//Sub Top Console
		//Menu
	if (ImGui::SmallButton("Send Fake Error")) { AddLog("[error] something went wrong"); } ImGui::SameLine();
...
void Console::ExecCommand(const char* command_line)
{
	...
	else if (Stricmp(command_line, "MOUSE_DEBUG") == 0)
	{
		mouseDebug = !mouseDebug;
		AddLog("Mouse Debug: %d", mouseDebug);
	}
	else
	{
