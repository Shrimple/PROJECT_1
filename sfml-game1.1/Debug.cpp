...
void Debug::printPPos(MNEngine* const ePtr) {
	printf("player pos : x->%d y->%d/n ", ePtr->EM.player->getPos().getX(), ePtr->EM.player->getPos().getY());
}
...
void Debug::updateOSD(MNEngine* const ePtr, TileMap * map) {
	if (os_debug) {
		int cT = map->getTile(ePtr->EM.player->getPos().getX(), ePtr->EM.player->getPos().getY()).type,
			rT = map->getTile((ePtr->EM.player->getPos().getX() + ePtr->TILE_SIZE), ePtr->EM.player->getPos().getY()).type,
			tT = map->getTile(ePtr->EM.player->getPos().getX(), (ePtr->EM.player->getPos().getY() - ePtr->TILE_SIZE)).type,
			lT = map->getTile((ePtr->EM.player->getPos().getX() - ePtr->TILE_SIZE), ePtr->EM.player->getPos().getY()).type,
			bT = map->getTile(ePtr->EM.player->getPos().getX() , (ePtr->EM.player->getPos().getY() + ePtr->TILE_SIZE)).type,
			trT = map->getTile((ePtr->EM.player->getPos().getX() + ePtr->TILE_SIZE), ePtr->EM.player->getPos().getY() - ePtr->TILE_SIZE).type,
			brT = map->getTile(ePtr->EM.player->getPos().getX() + ePtr->TILE_SIZE, (ePtr->EM.player->getPos().getY() + ePtr->TILE_SIZE)).type,
			tlT = map->getTile((ePtr->EM.player->getPos().getX() - ePtr->TILE_SIZE), ePtr->EM.player->getPos().getY() - ePtr->TILE_SIZE).type,
			blT = map->getTile(ePtr->EM.player->getPos().getX() - ePtr->TILE_SIZE, (ePtr->EM.player->getPos().getY() + ePtr->TILE_SIZE)).type;

		cur.setFont(*ePtr->Cam.dFont); cur.setCharacterSize(20);
		cur.setPosition({ ePtr->Cam.camera->getCenter().x - 40.f, ePtr->Cam.camera->getCenter().y - 40.f });
		...
		right.setPosition({ ePtr->Cam.camera->getCenter().x - 20.f,ePtr->Cam.camera->getCenter().y - 40.f});
		...
		top.setPosition({ ePtr->Cam.camera->getCenter().x - 40, ePtr->Cam.camera->getCenter().y - 60.f});
		...
		left.setPosition({ ePtr->Cam.camera->getCenter().x - 60.f,ePtr->Cam.camera->getCenter().y - 40.f });
		...
		bot.setPosition({ ePtr->Cam.camera->getCenter().x - 40.f,ePtr->Cam.camera->getCenter().y - 20.f });
		...
		topRight.setPosition({ ePtr->Cam.camera->getCenter().x - 20.f,ePtr->Cam.camera->getCenter().y - 60.f });
		...
		topLeft.setPosition({ ePtr->Cam.camera->getCenter().x - 60.f, ePtr->Cam.camera->getCenter().y - 60.f });
		...
		botRight.setPosition({ ePtr->Cam.camera->getCenter().x - 20.f,ePtr->Cam.camera->getCenter().y - 20.f });
		...
		botLeft.setPosition({ ePtr->Cam.camera->getCenter().x - 60.f,ePtr->Cam.camera->getCenter().y - 20.f });
		...
		x.setPosition({ ePtr->Cam.camera->getCenter().x - 60.f,ePtr->Cam.camera->getCenter().y + 40.f });
		x.setString("x:" + std::to_string(ePtr->EM.player->getPos().getX())); x.setFillColor(sf::Color::Black);
		x.setOutlineThickness(1); x.setOutlineColor(sf::Color::White);

		y.setFont(*ePtr->Cam.dFont); y.setCharacterSize(20);
		y.setPosition({ ePtr->Cam.camera->getCenter().x, ePtr->Cam.camera->getCenter().y + 40.f });
		y.setString("y:" + std::to_string(ePtr->EM.player->getPos().getY())); y.setFillColor(sf::Color::Black);
		y.setOutlineThickness(1); y.setOutlineColor(sf::Color::White);

		xV.setFont(*ePtr->Cam.dFont); xV.setCharacterSize(20);
		xV.setPosition({ ePtr->Cam.camera->getCenter().x - 60.f,ePtr->Cam.camera->getCenter().y + 20.f });
		...
		yV.setPosition({ ePtr->Cam.camera->getCenter().x,ePtr->Cam.camera->getCenter().y + 20.f});
